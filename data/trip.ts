  ...
  days: [
    {
      ...
      stops: [
        ...
        { time: '13:00–14:20', name: '入境、領行李、租車' },
        { time: '14:20–15:20', name: '租車、取車與確認車況', note: '確認 ETC 卡、導航／CarPlay、保險、加油種類、車損照片、雨刷與右駕操作。' },
    ...
    },
    {
      ...
      stops: [
        ...
        { time: '15:00–15:30', name: '開往許田休息站', note: '以導航即時車程為準；最晚 16:15 準備返回住宿。', highlightTerms: ['許田休息站'] },
        { time: '15:30–16:15', name: '許田休息站', note: '小吃、伴手禮、休息、廁所與海景。', highlightTerms: ['許田休息站'] },
    ...
    },
    {
      ...
      stops: [
        ...
        { time: '10:30–13:30', name: '永旺夢樂城百貨公司逛逛逛街', navigationName: 'AEON MALL Okinawa Rycom', note: 'Day 3 主要行程；午餐百貨美食街，A&W／塔可飯。' },
